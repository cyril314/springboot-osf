 ...
 * @DATE 2018/5/2
 */
public class FitPluginAdapter extends PluginAdapter {
    ...
    public static void main(String[] args) {
        String config = FitPluginAdapter.class.getClassLoader().getResource("mybatis-generator.xml").getFile();
    ...
    public List<GeneratedJavaFile> contextGenerateAdditionalJavaFiles(IntrospectedTable introspectedTable) {
        ...
        String targetProject = introspectedTable.getGeneratedJavaFiles().get(0).getTargetProject() + File.separator + targetBusine.replace(".", "/");
...
//        makeSerializable(topLevelClass, introspectedTable);
    ...
    public boolean methodXMLGenerated_one(Document document, IntrospectedTable introspectedTable) {
        ...
        select.addElement(new TextElement("order by `" + primaryKeyColumn + "` desc "));
        select.addElement(new TextElement("<if test=\"offset != null and limit != null\">\n\tlimit ${offset}, ${limit}\n\t</if>"));
