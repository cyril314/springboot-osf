...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${ctx}/static/css/navbar.css">
 	...
 	<link rel="stylesheet" type="text/css" href="${ctx}/static/css/font-awesome.min.css">
  	<link rel="stylesheet" type="text/css" href="${ctx}/static/css/froala_editor.min.css">
  	<link rel="stylesheet" type="text/css" href="${ctx}/static/css/froala_style.min.css">
...
<!-- 				  <div class="inline field">
	...
	<div class="ui basic small modal cancel-tip">
  	...
  	<script type="text/javascript" src="${ctx}/static/js/froala_editor.min.js"></script>
    ...
    <script type="text/javascript" src="${ctx}/static/js/code.js"></script>
  	<script type="text/javascript" src="${ctx}/static/js/tag.js"></script>
  	<%-- <script type="text/javascript" src="${ctx}/static/js/post.js"></script> --%>
  	<script>
      $(function() {
          $('#content').editable({
        	  inlineMode: false,
