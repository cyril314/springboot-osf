...
<link rel="stylesheet" type="text/css" href="${ctx}/static/css/jquery.fullPage.css">
<link rel="stylesheet" type="text/css" href="${ctx}/static/css/welcome.css">
<style>
.section1 { background: url('${ctx}/static/img/background.png') no-repeat; background-size: cover;}
.section4 { background: url('${ctx}/static/img/gallery/8.jpg') no-repeat; background-size: cover;}
</style>
...
<div id="welcome">
	<div class="section section1">
					...
					<div class="row">
						...
						<div class="span6">
							<div class="login ui form">
								...
								<div id="error" class="ui red inverted segment hidden"></div>
								<div class="field">
		...
		<div class="pulldown_tip">
			<img src="${ctx}/static/img/pulldown_tip.png" alt="向下滑动">
		</div>
	</div>
